...
import { ArrowRight, Award, ChefHat, Droplets, Leaf, Hand, MapPin } from 'lucide-react';
...
const featureIcons: Record<string, any> = {
  'Nocellara del Belice': Droplets,
  'Raccolto a Mano': Hand,
  'Molitura a Freddo': Leaf,
  'Due Generazioni': Award,
};
    ...
    return (
      <div className="min-h-screen bg-farina-100 flex items-center justify-center">
        <div className="text-center">
          <Droplets className="w-16 h-16 text-granite-600 animate-pulse mx-auto mb-4" />
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute bottom-20 left-0 w-80 h-80 bg-granite-600/5 rounded-full blur-3xl" />

        {/* Pattern */}
        <div className="absolute inset-0 opacity-[0.02]" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='30' cy='30' r='10' fill='%235C6B4A' fill-opacity='1'/%3E%3C/svg%3E")`,
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                <motion.img
                  src="/images/logo.jpg"
                  alt="Piccola Azienda Agricola - Olio Extravergine"
      ...
      <section className="section bg-white">
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {siteData.features.map((feature: { title: string; description: string }, index: number) => {
              const IconComponent = featureIcons[feature.title] || Droplets;
              return (
                <motion.div
                  key={feature.title}
                  initial={{ opacity: 0, y: 20 }}
          ...
          >
            <div>
              ...
              <p className="text-granite-600 max-w-xl">
                Olio Extravergine IGP Nocellara del Belice. Scegli il formato più adatto alle tue esigenze.
              </p>
            </div>
            <Link
              to="/prodotti"
            ...
            {featuredProducts.map((product, index) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  {product.price && (
                    <p className="text-lg font-semibold text-granite-600 mt-3">
                      €{product.price}
                    </p>
                  )}
                </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full text-granite-300 text-sm font-medium mb-6">
              ...
              <Link
                to="/ristoranti"
                className="btn bg-white text-granite-950 hover:bg-granite-100 hover:-translate-y-0.5"
              >
                Scopri di Più
                <ArrowRight className="w-5 h-5" />
              </Link>
            ...
            >
              {/* Info box */}
              <div className="bg-granite-900 rounded-2xl p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-granite-800 rounded-xl flex items-center justify-center">
                    <MapPin className="w-6 h-6 text-granite-400" />
                  </div>
                  <div>
                    <p className="font-semibold text-white">Castelvetrano</p>
                    <p className="text-sm text-granite-400">Valle del Belice, Sicilia</p>
                  </div>
                </div>
                <p className="text-granite-300 mb-6">
                  Il nostro olio nasce qui, nel cuore della Valle del Belice, dove la Nocellara trova il suo habitat naturale da secoli.
                </p>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-granite-800 rounded-xl p-4 text-center">
                    <p className="text-2xl font-bold text-white">IGP</p>
                    <p className="text-xs text-granite-400">Certificato</p>
                  </div>
                  <div className="bg-granite-800 rounded-xl p-4 text-center">
                    <p className="text-2xl font-bold text-white">2</p>
                    <p className="text-xs text-granite-400">Generazioni</p>
                  </div>
                </div>
              </div>
            </motion.div>
