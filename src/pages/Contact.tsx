...
export function ContactPage() {
  ...
  return (
    <>
      <SEO
        title="Contatti"
        description="Contattaci per ordinare il nostro Olio Extravergine IGP Nocellara del Belice. Spedizioni in tutta Italia."
        url="/contatti"
      />
            ...
            >
              ...
              <div className="bg-white rounded-2xl p-6 shadow-warm space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-4">
                    <Clock className="w-5 h-5 mt-1 flex-shrink-0 text-granite-600" />
                    <div>
                      <p className="font-medium text-granite-950">Spedizioni</p>
